...
public static void main(String[] args) {
	...
	List<String> list = new ArrayList<String>(); //1. 8부터는 생성자에 제네릭 표기
	//List<String> list = new LinkedList<>();
	
	String str1 = "Java";
	String str2 = "SpringBoot";
	System.out.println(list);//컬렉션 특성상 toString()이 이미 재정의되어 주소가 안나오고 내부요소가 나옴
	
	//list에 객체를 저장하는 메서드 add(): 데이터를 마지막지점에 추가
	list.add(str1);
	list.add(str2);
	list.add("Database");
	list.add("JDBC");
