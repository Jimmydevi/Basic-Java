...
public class MyBirthday {
	...
	/*
	 * 은닉된 변수에 접근하기 위해서는
	 * 클래스 설계시 미리 설정해둔 setter / getter 매서드를
	 * 이용해 데이터에 접근해야 합니다.
	 */
	...
	/*
	 * - getter 메서드 선언.
	 * 1. getter 메서드는 말 그대로 수를 get하는 용도입니다.
	...
	//year, month에 대해서 여러분들이 setter/getter을 모두 만들어주세요.
	public void setYar(int year) {
		if(year < 2023) {
			this.year = 2023;
		}else if(year <0) {
			this.year = -year;
