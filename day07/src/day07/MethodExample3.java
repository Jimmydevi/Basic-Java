...
public class MethodExample3 {
	...
	// System.out.prinln(add(3, 5))와 결과 동일
	
	// 리턴자료가 있는 함수는 매직넘버 대신 사용할 수 있따.
